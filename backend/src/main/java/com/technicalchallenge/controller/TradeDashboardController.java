...
//         @ApiResponse(responseCode = "500", description = "Internal server error")
//     })
//     public ResponseEntity<List<TradeDTO>> getTradesByBook(@PathVariable Long id, @RequestParam Long userId) {
...
//     //     return ResponseEntity.ok(tradeService.getTradeSummaryForUser(userId));
//     // }
...
//     //     return ResponseEntity.ok(tradeService.getDailySummaryForUser(userId));
//     // }
// }
